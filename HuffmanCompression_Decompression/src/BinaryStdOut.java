...
// Modifications by Jonathan Carpenter
// Date 4/20/2016
// Description: I have made the BinaryStdIn an instatiable class by chaingin
// all methods and variables except EOF to non-static
...
public final class BinaryStdOut {
    ...
    // don't instantiate
    public BinaryStdOut(BufferedOutputStream out) {
	this.out = out;
    }
